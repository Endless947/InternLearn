...
class ProgressCompletedLessonsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (lessons.isEmpty) {
      return const Center(
        child: Text(
          'No completed lessons yet. Finish a subtopic to see it here.',
        ),
      );
    }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          '${lesson.topicName.isNotEmpty ? ' • ${lesson.topicName}' : ''}',
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _LessonChip(
                              label: '+${lesson.xpEarned} XP',
                              color: Colors.deepOrange,
                            ),
                            _LessonChip(
                              label: DateFormat(
                                'MMM d, h:mm a',
                              ).format(lesson.completedAt),
                              color: Colors.teal,
                            ),
                          ],
                        ),
